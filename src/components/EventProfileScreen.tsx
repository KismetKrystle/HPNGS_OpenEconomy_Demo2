...
import { PublicEvent, EventSignup, MediaItem } from '../types/events';
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  {(event.signups?.length ?? 0) > 5 && (
                    <p className="text-sm text-muted-foreground text-center pt-2">
                      +{(event.signups?.length ?? 0) - 5} more
                    </p>
                  )}
                </div>
              </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">{event.analytics?.attendeesCount ?? 0}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-medium">{event.analytics?.performersCount ?? 0}</span>
              </div>

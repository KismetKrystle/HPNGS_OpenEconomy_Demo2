...
export function InboxScreen({ mediaItems, onUpdateStatus, onMintNFT }: InboxScreenProps) {
    ...
    <div className="p-4">
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground">
          {mediaItems.length} item{mediaItems.length !== 1 ? 's' : ''} pending review
        </p>
      </div>

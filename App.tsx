...
import { Camera, Plus, Inbox, ShoppingBag, User, Home, Calendar } from 'lucide-react';
...
export default function App() {
  ...
  const [artists, setArtists] = useState<Artist[]>([
    {
      ...
      name: 'Luna Dreams',
      handle: 'lunar_dreams',
      avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b9f3?w=150&h=150&fit=crop',
      category: 'music',
      isLive: true,
      followers: 15200,
  ...
  const renderScreen = () => {
    if (currentScreen === 'landing') {
      return (
        <LandingScreen
          onEnterSite={() => setCurrentScreen('camera')}
        />
      );
    }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header with App Name and Inbox */}
      {showAppHeader && (
